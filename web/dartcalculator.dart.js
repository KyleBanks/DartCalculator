...
$$._FrozenElementListIterator = {"": "Object;_list,_liblib1$_index,_liblib1$_current",
  moveNext$0: function() {
    var t1, nextIndex, t2;
    ...
    if (nextIndex < t2) {
      this._liblib1$_current = t1.$index(t1, nextIndex);
...
$$._AttributeClassSet = {"": "CssClassSet;_liblib0$_element",
  readClasses$0: function() {
    ...
    t1 = $.get$attributes$x(this._liblib0$_element);
  ...
  writeClasses$1: function(s) {
    var t1 = $.get$attributes$x(this._liblib0$_element);
...
$.main = function() {
  $.screen = document.querySelector("#calculator_screen");
  $.numbers = $.queryAll$1$x(document, ".number");
  for (var t1 = $.get$iterator$ax($.numbers); t1.moveNext$0();)
    $.get$onClick$x(t1.get$current()).listen$1($.numberClicked);
  $.decimal = document.querySelector("#decimal");
  $.get$onClick$x($.decimal).listen$1($.decimalClicked);
  $.clear = document.querySelector("#clear");
  $.get$onClick$x($.clear).listen$1($.clearScreen);
  $.clearAll = document.querySelector("#clear-everything");
  $.get$onClick$x($.clearAll).listen$1($.clearEverything);
  $.add = document.querySelector("#add");
  $.get$onClick$x($.add).listen$1($.addClicked);
  $.subtract = document.querySelector("#subtract");
  $.get$onClick$x($.subtract).listen$1($.subtractClicked);
  $.multiply = document.querySelector("#multiply");
  $.get$onClick$x($.multiply).listen$1($.multiplyClicked);
  $.divide = document.querySelector("#divide");
  $.get$onClick$x($.divide).listen$1($.divideClicked);
  $.equals = document.querySelector("#equals");
  $.get$onClick$x($.equals).listen$1($.equalsClicked);
  $.set$text$x($.screen, "0");
  $.operationType = -1;
...
$.numberClicked = function($event) {
  ...
  if (t2.get$text(t1) === "0")
    t2.set$text(t1, "");
  if ($.get$length$asx(t2.get$text(t1)) < 10) {
    t1 = $.screen;
    t2 = $.getInterceptor$x(t1);
    t2.set$text(t1, $.$add$ns(t2.get$text(t1), $.get$toElement$x($event).textContent));
  }
};

$.decimalClicked = function($event) {
  var t1, t2;
  if (!$.contains$1$asx($.get$text$x($.screen), ".")) {
    t1 = $.screen;
    t2 = $.getInterceptor$x(t1);
    t2.set$text(t1, $.$add$ns(t2.get$text(t1), "."));
  }
};
...
$.addClicked = function($event) {
  $.operationType = 1;
  $.operationTypeChanged($.get$toElement$x($event));
};

$.subtractClicked = function($event) {
  $.operationType = 2;
  $.operationTypeChanged($.get$toElement$x($event));
};

$.multiplyClicked = function($event) {
  $.operationType = 3;
  $.operationTypeChanged($.get$toElement$x($event));
};
...
$.operationTypeChanged = function(selected) {
  var operationElements, t1, t2;
  operationElements = $.queryAll$1$x(document, ".operation");
  for (t1 = operationElements.get$iterator(operationElements); t1.moveNext$0();) {
    t2 = $.get$classes$x(t1.get$current());
    t2.remove$1(t2, "selected");
  }
  if ($.$eq($.operationType, -1) !== true) {
    t1 = $.get$classes$x(selected);
    t1.add$1(t1, "selected");
    if ($.number1 == null) {
      $.number1 = $.Primitives_parseDouble($.get$text$x($.screen), null);
      $.set$text$x($.screen, "0");
    }
  }
};
...
$.equalsClicked = function($event) {
  var number2, result, displayString;
  if ($.number1 != null && $.$eq($.operationType, -1) !== true) {
    number2 = $.Primitives_parseDouble($.get$text$x($.screen), null);
    result = null;
    switch ($.operationType) {
      case 1:
        result = $.$add$ns($.number1, number2);
        break;
      case 2:
        result = $.$sub$n($.number1, number2);
        break;
      case 3:
        result = $.$mul$n($.number1, number2);
        break;
      case 4:
        result = $.$div$n($.number1, number2);
        break;
    }
    $.set$text$x($.screen, "0");
    $.operationType = -1;
    $.operationTypeChanged(null);
    $.number1 = null;
    displayString = $.toString$0(result);
    if (displayString.length > 10)
      displayString = $.JSString_methods.substring$2(displayString, 0, 10);
    $.set$text$x($.screen, displayString);
  }
};
...
$.numberClicked.call$1 = $.numberClicked;
$.numberClicked.$name = "numberClicked";
$.decimalClicked.call$1 = $.decimalClicked;
$.decimalClicked.$name = "decimalClicked";
$.clearScreen.call$1 = $.clearScreen;
$.clearScreen.$name = "clearScreen";
$.clearEverything.call$1 = $.clearEverything;
$.clearEverything.$name = "clearEverything";
$.addClicked.call$1 = $.addClicked;
$.addClicked.$name = "addClicked";
$.subtractClicked.call$1 = $.subtractClicked;
$.subtractClicked.$name = "subtractClicked";
$.multiplyClicked.call$1 = $.multiplyClicked;
$.multiplyClicked.$name = "multiplyClicked";
$.divideClicked.call$1 = $.divideClicked;
$.divideClicked.$name = "divideClicked";
$.equalsClicked.call$1 = $.equalsClicked;
$.equalsClicked.$name = "equalsClicked";
...
//@ sourceMappingURL=dartcalculator.dart.js.map
